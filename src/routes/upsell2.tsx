...
// Isolated upsell #2 page — replicates the reference layout (Activate the Fast Payment Channel)
...
export const Route = createFileRoute("/upsell2")({
  head: () => ({
    meta: [
      { title: "Activate the Fast Payment Channel" },
      { name: "description", content: "Watch the short video below to enable faster processing." },
      { name: "robots", content: "noindex, nofollow" },
      { property: "og:title", content: "Activate the Fast Payment Channel" },
...
function Upsell2Page() {
  ...
  // Sync CTA reveal with actual video playback time
  useEffect(() => {
    ...
    <div className="min-h-screen bg-white text-slate-900 flex flex-col">
        ...
        <section className="mx-auto w-full max-w-3xl px-4 mt-8 text-center animate-fade-in">
          ...
          <div className="mt-6">
            <div className="h-3 w-full rounded-full bg-slate-100 overflow-hidden">
              <div
                className="h-full"
                style={{ width: "99%", backgroundColor: ACCENT, transition: "width 1s ease" }}
              />
            </div>
      ...
      {ctaUnlocked && (
        <section className="mx-auto w-full max-w-3xl px-4 mt-6 mb-12 flex flex-col items-center gap-4 animate-fade-in">
          ...
          >
            I don't want it, I'll leave it for someone else.
          </a>
        </section>
      )}
      ...
      >
        <div className="mx-auto max-w-3xl px-4 py-8 text-center text-[11px] leading-relaxed text-slate-500 sm:text-xs">
          <div className="mb-6 flex flex-col items-center gap-3">
            ...
            <a href={NO_URL} className="text-slate-400 hover:text-slate-600 underline text-xs text-center">
              I don't want it, I'll leave it for someone else.
            </a>
          </div>
