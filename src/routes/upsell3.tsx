      ...
      >
        <div className="mx-auto max-w-3xl px-4 py-8 text-center text-[11px] leading-relaxed text-slate-500 sm:text-xs">
          <div className="mb-6 flex flex-col items-center gap-3">
            <a
              href={YES_URL}
              className="w-full sm:w-auto inline-flex items-center justify-center text-center px-6 py-3 rounded-lg bg-[#16a34a] hover:bg-[#15803d] text-white font-bold uppercase tracking-wide text-sm shadow-md transition-transform active:scale-[0.98]"
            >
              I WANT ACCESS TO THE HIDDEN SYSTEM
            </a>
